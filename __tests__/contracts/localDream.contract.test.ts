...
describe('LocalDream Contract', () => {
  ...
  describe('loadModel', () => {
    it('should accept valid model loading params', async () => {
      ...
      const params = {
        modelPath: '/data/user/0/ai.lmlocal/files/models/sdxl-turbo',
        threads: 4,
  ...
  describe('generateImage', () => {
    ...
    it('should accept valid generation params', async () => {
      const mockResult = {
        id: 'img-123',
        imagePath: '/data/user/0/ai.lmlocal/files/generated/img-123.png',
        width: 512,
        height: 512,
        seed: 12345,
      };
  ...
  describe('Progress Events', () => {
    ...
    it('should support optional preview path in progress events', () => {
      const progressWithPreview = {
        ...
        totalSteps: 20,
        progress: 0.75,
        previewPath: '/data/user/0/ai.lmlocal/files/previews/step-15.png',
      };
